...
class ArenasListMap extends React.Component {
    constructor(props) {
        ...
        this.boroughs = {
            manhattan: { bounds: { lat: 40.7493039, lng: -74.0070414 }, zoom: 13 },
            brooklyn: { bounds: { lat: 40.6468861, lng: -73.9869644 }, zoom: 12 },
            queens: { bounds: { lat: 40.7282, lng: -73.7949 }, zoom: 12 },
            bronx: { bounds: { lat: 40.8448, lng: -73.8648 }, zoom: 12 },
