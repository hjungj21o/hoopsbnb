...
hj = User.create(username: "ballislife", email: "ballislife@gmail.com", first_name: "Haejun", last_name: "Chung")
mj = User.create(username: "thegoat23", email: "thegoat23@airjordan.com", first_name: "Michael", last_name: "Jordan")
ki = User.create(username: "earthisflat", email: "kyrieirving@brooklynnets.com", first_name: "Kyrie", last_name: "Irving")
